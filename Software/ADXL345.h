...
class ADXL345
{
	...
	Vector readNormalizeCorrected(float gravityFactor = ADXL345_GRAVITY_EARTH);
	...
	void setNormalizeCorrectionXYZ(Vector *min_values, Vector *max_values);
